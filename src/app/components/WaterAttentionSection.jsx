...
/* Real Google Map iframe container wrapper */
const RealMapWrapper = styled.div`
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
const LegendCard = styled.div`
  ...
  flex-direction: column;
  gap: 0.5rem;
  z-index: 10; /* Ensures the legend sits cleanly above the map view */
`;
  ...
  return (
    <AttentionSection>
      <ContentContainer>
        ...
        {/* Right Map Visual Card element */}
        <MapVisualPane>
          <RealMapWrapper>
            <iframe
              title="El Paso Texas Map"
              src="https://maps.google.com/maps?q=El%20Paso,%20TX&t=&z=11&ie=UTF8&iwloc=&output=embed"
              loading="lazy"
              allowFullScreen
            />
          </RealMapWrapper>
